...
swap_router_contract = web3.eth.contract(
    address=swap_router02_address, abi=UNISWAP_V3_ROUTER2_ABI
)
...
path = eth_abi.packed.encode_packed(
    ["address", "uint24", "address"], [weth_address, 500, usdt_address]
)
...
path = eth_abi.packed.encode_packed(
    ["address", "uint24", "address"], [usdt_address, 500, weth_address]
)
